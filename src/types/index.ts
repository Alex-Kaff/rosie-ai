...
export type ActionType = "produce_text" | "delete_conversation" | "search_pc" | "add_memory" | "run_cmd";

export type ActionParams<T extends ActionType> = T extends "produce-text" ? {
  inputMessage: Input;
  mode: "thinking" | "normal" | "fast"
} : T extends "delete_conversation" ? {
